...
public class CartManageServiceImpl implements CartManageService{
	...
	public int addOrderByCart(String cartid,String username) {
		...
		try {
			...
			Commodity commodity = commodityDao.getCommodityById(productid);
			int oldAmount = commodity.getProductMargin();
			int newAmount = oldAmount-amount;
			cartManageDao.updateProductMargin(newAmount+"",productid);
			return 1;
