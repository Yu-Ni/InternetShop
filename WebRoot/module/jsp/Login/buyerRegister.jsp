	...
	$(function() {
		$("#usernameSHU").blur(function() {
			...
			$.ajax({
				...
				url : 'loginController/validateBuyer.do',
				dataType : 'json',
...
<body>
	<form method="post" enctype="multipart/form-data"
		action="loginController/buyerRegister.do">
		...
		<div class="input-group">
			<span class="input-group-addon">登录密码</span> <input type="password" id="password"
				class="form-control" name="password">
		</div>
		<div class="input-group">
			<span class="input-group-addon">联系方式</span> <input type="text" id="telphone"
				class="form-control" name="telphone">
		</div>
		<div class="input-group">
			<span class="input-group-addon">用户头像</span> <img id="imageview"
				width="100px" height="100px"
				src="./module/img/Login/defaultHeader.jpg"> <input type="file"
				class="form-control" name="file" id="fileUpload" />
		</div>
		<div class="input-group">
			<span class="input-group-addon">用户性别</span> <input type=radio
				name="sex" checked value="0">男
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input type=radio
				name="sex" value="1">女
		</div>
		<div>
			<input type="submit" value="注册" class="registerBtn" id="registBtn"/> <input
				type="button" value="取消" class="registerBtn"
